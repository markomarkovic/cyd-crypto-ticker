...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (13 * 1024U)          /*[bytes]*/ /* Reduced to 13KB to enable screenshots */
...
#define LV_DRAW_LAYER_SIMPLE_BUF_SIZE    (8 * 1024)   /*[bytes]*/ /* Reduced from 24KB to free memory for screenshots */

/* The stack size of the drawing thread.
 * NOTE: If FreeType or ThorVG is enabled, it is recommended to set it to 32KB or more.
 */
#define LV_DRAW_THREAD_STACK_SIZE    (4 * 1024)   /*[bytes]*/ /* Reduced from 8KB to free memory for screenshots */
...
#define LV_FONT_CUSTOM_DECLARE   LV_FONT_DECLARE(jetbrains_mono_12) \
...
#define LV_USE_LED        0  /* Disabled to save space */
...
#define LV_USE_MENU       0  /* Disabled to save space */

#define LV_USE_MSGBOX     0  /* Disabled to save space */

#define LV_USE_ROLLER     0  /* Disabled to save space */

#define LV_USE_SCALE      0  /* Disabled to save space */

#define LV_USE_SLIDER     0  /* Disabled to save space */

#define LV_USE_SPAN       0  /* Disabled to save space */
#if LV_USE_SPAN
    /*A line text can contain maximum num of span descriptor */
    #define LV_SPAN_SNIPPET_STACK_SIZE 64
#endif

#define LV_USE_SPINBOX    0  /* Disabled to save space */
...
#define LV_USE_TABLE      0  /* Disabled to save space */

#define LV_USE_TABVIEW    0  /* Disabled to save space */

#define LV_USE_TILEVIEW   0  /* Disabled to save space */

#define LV_USE_WIN        0  /* Disabled to save space */
